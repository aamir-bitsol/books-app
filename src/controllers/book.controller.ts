...
export const getAllBooks = async (
  ...
  const books: any = await Book.findAll({
    ...
    include: [{ model: User, as: "author", attributes:{exclude:["id", "createdAt", "updatedAt", "password"]}}],
  });
...
export const getSpecificBook = async (
  ...
  const book: any = await Book.findOne({
    where: { id },
    include: [{ model: User, as: 'author', attributes:{exclude: ["password", "createdAt", "updatedAt", "UserId"]} }],
    attributes:{
      exclude:['UserId'],
    }
  });
